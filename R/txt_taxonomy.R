txts$main$taxonomy <- list(
  ...
  methodology = list(
    title = "Methodology",
    content = "The definition of the GRETA taxonomy followed a mixed methodological
  ...
  help = list(
    scheme = list(
      ...
      content = HTML(
        "Explore the interactive scheme below to learn about GRETA's
        geographical taxonomy. You can click on each element to understand the
        taxonomy's <b>geographical levels</b> and <b>proxmity domains</b> in more
        detail.
        <br>
        The taxonomy was first introduced in
        <a href=https://projectgreta.eu/wp-content/uploads/2022/02/GRETA_D5_1_
        Taxonomy-of-geographical-levels-and-drivers_v1_0.pdf#page=34>Deliverable
        D5.1</a> of the GRETA project."
      )
    )
  ),
  scheme = list(
    ...
    header = list(
      title = "GRETA levels",
      content = "GRETA Taxonomy is based on a multi-level approach that takes into
    ...
    virtual = list(
      title = "Virtual level",
      content = "The level of virtual proximity refers to the relational closeness
    ...
    local = list(
      title = "Local level",
      content = "The local geographical level can be described through several domains.
    ...
    regional = list(
      ...
      content = "The regional level is the most common dimension where energy
        ...
        French, etc.), sub-statal entities (Germany \u201cL\u00e4nder\u201d) or
        federal autonomies (Spanish \u201cComunidades Aut\u00f3nomas\u201d,
        rumenian \u201cvoivodati\u201d)."
    ),
    national = list(
      title = "National level",
      content = "The national level of energy citizenship emergence has mostly to do
    ...
    supranational = list(
      ...
      content = "The supranational level provides proximity mechanisms mainly through a
    ...
    prox = list(
      ...
      content = "Proximity indicated the closeness (or distance) of two or more
    ...
    spatial = list(
      ...
      content = "The spatial domain describes the physical proximity between people and
    ...
    policy = list(
      title = "Policy domain",
      content = "The policy and governance domain defines management and planning
    ...
    social = list(
      title = "Social domain",
      content = "The social domain identifies the relationalities connecting the
    ...
    tech = list(
      ...
      content = "The technological domain entails proximity to technologies and digital
    ...
    econ = list(
      ...
      content = "The economic domain, with the market, sustainability, and economic
    ...
    dims = list(
      ...
      content = "Dimensions are analytical expressions of the different domains,
